...
public class LoguinPage {
    ...
    public static final Target GET_INTO = Target.the("Clic ingresar").located(By.id("login-submit"));
    public static final Target INVALID_CREDENTIALS_MESSAGE = Target.the("Clic ingresar").located(By.xpath("//div[contains(text(), 'Usuario o contraseña inválidos')]"));
}
